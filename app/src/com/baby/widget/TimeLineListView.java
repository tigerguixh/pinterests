...
public class TimeLineListView extends ListView implements OnScrollListener{
	...
	public TimeLineListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TimeLineListView);
        final int scrollBarPanelLayoutId = a.getResourceId(
                R.styleable.TimeLineListView_scrollBarPanel, -1);
        final int scrollBarPanelInAnimation = a.getResourceId(
                R.styleable.TimeLineListView_scrollBarPanelInAnimation, R.anim.in_animation);
        final int scrollBarPanelOutAnimation = a.getResourceId(
                R.styleable.TimeLineListView_scrollBarPanelOutAnimation, R.anim.out_animation);
        a.recycle();
                    ...
                    if (childView != null) {
                        if (thumbOffset > childView.getTop() && thumbOffset < childView.getBottom()) {
                            ...
                            if (mLastPosition != firstVisibleItem + i) {
                                 ...
                                 */
                                mPositionChangedListener.onPositionChanged(this, firstVisibleItem,
                                        mScrollBarPanel);
