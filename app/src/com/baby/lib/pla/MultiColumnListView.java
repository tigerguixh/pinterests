...
public class MultiColumnListView extends PLA_ListView {
	...
	private static int DEFAULT_COLUMN_NUMBER = 3;

	private static int mColumnNumber = 3;
	
	public static void changeColumn(int num){
		DEFAULT_COLUMN_NUMBER = num;
		mColumnNumber = num;
	}
	...
	private static int mColumnPaddingLeft = 0;
	private static int mColumnPaddingRight = 0;
	...
	private void init(AttributeSet attrs) {
		...
		mColumns = new Column[mColumnNumber+1];
